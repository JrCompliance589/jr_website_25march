        ...
        <div className="bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50">
          <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a
                href={`https://api.whatsapp.com/send?phone=919870122442&text=${encodeURIComponent(`Hi, I need help with ${title}`)}&type=phone_number&app_absent=0`}
                target="_blank"
      ...
      <section className="py-10 sm:py-14 lg:py-20 bg-slate-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <a href={`https://api.whatsapp.com/send?phone=919266450125&text=${encodeURIComponent(`Hi, I need help with ${title}`)}&type=phone_number&app_absent=0`} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-lg sm:rounded-xl border border-white/10 transition-all text-sm sm:text-base">
