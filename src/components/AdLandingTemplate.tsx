...
export default function AdLandingTemplate({
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      {/* Section 1: Hero + Form */}
      <section id="consultation" className="relative min-h-[60vh] sm:min-h-[70vh] overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-20 sm:pt-24 pb-8 sm:pb-12 lg:pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-start">
            ...
            {/* Right — Form Card (ServicePageTemplate style) */}
      ...
      {/* Section 2: Benefits */}
      <section id="benefits" className="py-10 sm:py-14 lg:py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-400 max-w-2xl mx-auto">{description}</p>
          </div>
