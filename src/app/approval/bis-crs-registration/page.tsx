...
const title = 'BIS CRS Registration';
const logo = '/services_logo/bis.png';
const colors = {
  bg: 'bg-blue-600',
  text: 'text-blue-400',
...
export default function BISCRSRegistrationPage() {
  ...
  const faqs = [
    { question: 'What is CRS Certification?', answer: 'BIS CRS Certification ensures safety for electronic and IT products in India meeting standards set by the Bureau of Indian Standards. It is applicable for specific products, for which the certification is mandatory.' },
    { question: 'Which products need CRS Registration?', answer: 'Products such as mobile phones, LED lights, power banks, etc., are there in the CRS BIS Scheme and need to have a certification.' },
    { question: 'How long does it take to get a BIS CRS Certificate in India?', answer: 'The time BIS CRS would consume varies according to how well the documentation is done and approval of any testing needed but would usually take a time frame of 4-6 weeks if all requirements are done timely.' },
    { question: 'What is the validity of CRS Certification?', answer: 'BIS CRS Registration Certificate in India valid for 2 years and must be renewed before expiry to continue selling in India.' },
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-start">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-4 sm:mb-6">
                ...
                <span className="text-xs sm:text-sm font-medium text-gray-300">Mandatory Product Registration under CRS Scheme</span>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-4 sm:mb-6 max-w-2xl">
                Mandatory Product Registration under CRS Scheme
              </p>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-400 mb-6 sm:mb-8 leading-relaxed">
                The BIS CRS Registration is a statutory provision in India, under the Bureau of Indian Standards Act, for various electronic and IT products. It guarantees that products ensure compliance to Indian safety standards before market entry. CRS registration helps maintain compliance and also strengthens competitive advantage through reliability and enhanced safety for a business&apos;s products.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">
              Overview of <span className={colors.text}>BIS CRS Registration</span>
            </h2>
          </div>
          <div className="max-w-4xl mx-auto space-y-4">
            <p className="text-sm sm:text-base lg:text-lg text-gray-400 leading-relaxed">
              The BIS CRS Registration is a statutory provision in India, under the Bureau of Indian Standards Act, for various electronic and IT products. It guarantees that products ensure compliance to Indian safety standards before market entry.
            </p>
            <p className="text-sm sm:text-base lg:text-lg text-gray-400 leading-relaxed">
              CRS registration helps maintain compliance and also strengthens competitive advantage through reliability and enhanced safety for a business&apos;s products.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
            {[
              ...
              { step: 'Category & Standard Mapping', description: 'We help in mapping your product to the correct category and identify relevant Indian standards.' },
              { step: 'Product Testing', description: 'Products will be tested in BIS-approved labs to make sure they fulfill safety and quality standards.' },
              { step: 'Application Submission', description: 'The application is sent for review along with the required documents and test results.' },
              { step: 'BIS Inspection & Review', description: 'The BIS team conducts inspections to validate documents and product conformity.' },
              { step: 'Certification Issuance', description: 'Upon successful verification, Authorities issue the certificate for marketing products in India.' },
            ].map((item, index) => (
      ...
      <section className="py-10 sm:py-14 lg:py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-400 max-w-3xl mx-auto mb-6">
              JR Compliance recommends expert suggestions for Compulsory Registration Scheme certification, ensuring that manufactured products comply with Indian safety regulations. Helps manufacturers to get <a href="/approval/bis-certification" className="text-blue-400 underline">BIS certification</a> with experienced consultants which identify applicable standards for your products and coordinate testing at BIS-recognized laboratories. We collect all essential documents and submit applications on the portal and track your certification status from start to finish. Also our team stays updated with the latest additions to the CRS product list, helping you maintain compliance as regulations evolve. We handle all communication with BIS authorities and provide timely responses to any queries. Post-registration, we offer annual renewal services, inclusion filing for new models, and ongoing compliance support to keep your products legally available in the Indian market.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div key={index} className="flex items-center gap-2 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-white/5 border border-white/5">
      ...
      <section className="py-10 sm:py-14 lg:py-20 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">
            Ready to Get <span className={colors.text}>BIS CRS Registration?</span>
          </h2>
